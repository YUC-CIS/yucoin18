Yucoin Core version *0.15.1* is now available from:

  <https://download.yucoin.org/yucoin-0.15.1/>
...
A number of changes to the way Yucoin Core deals with peer connections and invalid blocks
