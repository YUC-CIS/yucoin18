# Support for Output Descriptors in Yucoin Core

Since Yucoin Core v0.17, there is support for Output Descriptors. This is a
...
on Yucoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Yucoin Core wallets, a convenience function `combo` is
