...
### Build and sign yucoin Core for Linux, Windows, and OS X:

    pushd ./gitian-builder
    ./bin/gbuild --num-make 2 --memory 3000 --commit yucoin=v${VERSION} ../yucoin/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --num-make 2 --memory 3000 --commit yucoin=v${VERSION} ../yucoin/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --num-make 2 --memory 3000 --commit yucoin=v${VERSION} ../yucoin/contrib/gitian-descriptors/gitian-osx.yml
...
- Announce the release:
  ...
  - yucoin-dev and yucoin-dev mailing list
