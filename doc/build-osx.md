...
1. Clone the Yucoin Core source code:
...
2.  Build Yucoin Core:
    ...
    Configure and build the headless Yucoin Core binaries as well as the GUI (if Qt is found).
...
5.  Installation into user directories (optional):
    ...
    or
        ...
        cd ~/yucoin/src
        cp yucoind /usr/local/bin/
        cp yucoin-cli /usr/local/bin/
...
Before running, you may create an empty configuration file:
    ...
    mkdir -p "/Users/${USER}/Library/Application Support/Yucoin"

    touch "/Users/${USER}/Library/Application Support/Yucoin/yucoin.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/Yucoin/yucoin.conf"

The first time you run yucoind, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
