...
"""Verify that starting yucoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start yucoin with -h for help text")
        ...
        self.log.info("Start yucoin with -version for version information")
        ...
        self.log.info("Start yucoind with -fakearg to make sure it does not start")
