...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.yucoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.yucointools.com");
        vSeeds.emplace_back("dnsseed.yucoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.yucointools.com");
        vSeeds.emplace_back("seed-b.yucoin.loshan.co.uk");
