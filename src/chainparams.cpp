...
public:
    CMainParams() {
        ...
        //vSeeds.emplace_back("dnsseed.yucoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.yucointools.com", true);
        vSeeds.emplace_back("seed-b.yucoin.loshan.co.uk", true);
