...
const char * const BITCOIN_CONF_FILENAME = "yucoin.conf";
const char * const BITCOIN_PID_FILENAME = "yucoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "yucoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/yucoin";
#else
    // Unix
    return pathRet / ".yucoin";
#endif
#endif
}
