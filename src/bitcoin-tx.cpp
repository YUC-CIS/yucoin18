...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " yucoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  yucoin-tx [options] <hex-tx> [commands]  Update hex-encoded yucoin transaction\n" +
            "or:     yucoin-tx [options] -create [commands]   Create hex-encoded yucoin transaction\n" +
            "\n";
