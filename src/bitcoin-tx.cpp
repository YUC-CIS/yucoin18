...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s yucoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  yucoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded yucoin transaction") + "\n" +
              "  yucoin-tx [options] -create [commands]   " + _("Create hex-encoded yucoin transaction") + "\n" +
              "\n";
